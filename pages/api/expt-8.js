...
export default async function handler(req, res) {
  const API_URL = 'http://10.100.80.46/'; // Replace with the actual API URL
  const csvContent = ['accel_x, accel_y, accel_z']; // Array to store CSV data
  ...
  function downloadCSV() {
    ...
    const filePath = '/Users/vince/Desktop/Portfolio_Website/my-portfolio/public/data-8/data.txt'; // Replace with your desired file path
    i+=1
