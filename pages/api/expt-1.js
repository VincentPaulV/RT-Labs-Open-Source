...
export default async function handler(req, res) {
  ...
  function downloadCSV() {
    ...
    const filePath = '/Users/vince/Desktop/Portfolio_Website/my-portfolio/public/data-1/data.txt'; // Replace with your desired file path
    i+=1
  ...
  function startFetching() {
    fetch('http://10.100.81.244:3000/run-motor')
      .then(() => {
        setTimeout(() => {
