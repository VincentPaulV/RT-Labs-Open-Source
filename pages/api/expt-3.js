...
export default async function handler(req, res) {
  const API_URL = 'http://10.100.80.41/'; // Replace with the actual API URL
  const csvContent = ['accel_x, accel_y, accel_z']; // Array to store CSV data
  ...
  function downloadCSV() {
    ...
    const filePath = '/Users/vince/Desktop/Portfolio_Website/my-portfolio/public/data-3/data.txt'; // Replace with your desired file path
    i+=1
  ...
  function startFetching(freq) {
    ...
    fetch('http://10.100.80.45/mode_set?mode=SQUARE&slider='+freq)
      .then(() => {
